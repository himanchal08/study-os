...
interface GoogleCalendarPanelProps {
  ...
  mode?: "all" | "settings" | "tasks" | "sessions";
}
...
export function GoogleCalendarPanel({ isConnected, lastSyncedAt, mode = "all" }: GoogleCalendarPanelProps) {
    ...
    <div className="rounded-xl p-5" style={{ background: "#0a0a0a", border: "1px solid #1a1a1a" }}>
      <div className="flex items-center justify-between mb-1">
        <h2 className="text-sm font-semibold text-neutral-200">
          {mode === "tasks" ? "Google Tasks Sync" : mode === "sessions" ? "Calendar Sync" : "Google Integration"}
        </h2>
        {isConnected && (
      ...
      <p className="text-xs text-neutral-500 mb-4">
        {mode === "tasks" ? "Sync your planned tasks directly to your Google Tasks list." 
        : mode === "sessions" ? "Push your study sessions as timed Calendar events."
        : "Connect your Google account to sync tasks and calendar events."}
      </p>
        ...
        <div className="space-y-3">
          ...
          {(mode === "all" || mode === "settings") && (
            <button
              ...
              className="px-4 py-2 rounded-lg text-xs font-medium transition-all active:scale-95 disabled:opacity-50 mt-2"
