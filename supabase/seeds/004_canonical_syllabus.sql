...
DECLARE
  ...
  s_di          uuid := gen_random_uuid();
  s_reasoning   uuid := gen_random_uuid();
  s_computer    uuid := gen_random_uuid();
  s_eng_obj     uuid := gen_random_uuid();
  s_eng_desc    uuid := gen_random_uuid();
  s_ga_static   uuid := gen_random_uuid();
  s_ca          uuid := gen_random_uuid();
  s_bank_aware  uuid := gen_random_uuid();
  s_gen_sci     uuid := gen_random_uuid();
  s_nonverbal   uuid := gen_random_uuid();
